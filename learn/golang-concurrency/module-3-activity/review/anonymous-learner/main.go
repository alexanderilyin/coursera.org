...
func main() {
	...
	for {
		...
		/*
		   	Raca condition is when multiple threads are trying to access and manipulat the same
		   ...
		   variable.
		   	...
		   	Due to the uncertainty of Goroutine scheduling mechanism, the results of the following
